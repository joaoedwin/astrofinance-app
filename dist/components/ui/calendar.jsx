...
function Calendar({ className, classNames, showOutsideDays = true, ...props }) {
    // Criar uma versão modificada do locale ptBR com dias da semana de uma letra
    const customLocale = {
        ...locale_1.ptBR,
        localize: {
            ...locale_1.ptBR.localize,
            day: (day) => {
    ...
    return (<react_day_picker_1.DayPicker showOutsideDays={showOutsideDays} className={(0, utils_1.cn)("p-3", className)} locale={customLocale} classNames={{
